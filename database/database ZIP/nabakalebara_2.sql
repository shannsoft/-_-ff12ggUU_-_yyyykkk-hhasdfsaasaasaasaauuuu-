...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 07, 2015 at 09:30 AM
...
INSERT INTO `bus` (`BusID`, `BusNumber`, `BusName`, `FromStation`, `ToStation`, `StartsAt`, `ReachesAt`, `CityId`) VALUES
(1, 1, 'Bus_1', 'puri', 'kolkotta', '00:00:00', '01:00:00', 1);
...
(1, 1, 'train_1', 'puri', 'Kolkotta', '01:00:00', '10:00:00', 1, 1, 1, 0, 0, 0, 0, 1, 'http://www.w3schools.com/php/func_string_strlen.asp');
